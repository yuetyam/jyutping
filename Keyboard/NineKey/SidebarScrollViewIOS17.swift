...
@available(iOS, introduced: 17.0, deprecated: 18.0, message: "Use SidebarScrollView instead")
@available(iOSApplicationExtension, introduced: 17.0, deprecated: 18.0, message: "Use SidebarScrollView instead")
