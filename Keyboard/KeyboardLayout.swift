...
private extension KeyboardLayout {
        ...
        func cantoneseNumericKeys(_ needsInputModeSwitchKey: Bool) -> [[KeyboardEvent]] {
                ...
                let second_8: KeyboardEvent = {
                        ...
                        let child_3 = KeyElement(text: "\u{FE41}")
                        let child_4 = KeyElement(text: "\u{FE43}")
                ...
                let second_9: KeyboardEvent = {
                        ...
                        let child_3 = KeyElement(text: "\u{FE42}")
                        let child_4 = KeyElement(text: "\u{FE44}")
                        let seat: KeySeat = KeySeat(primary: primary, children: [primary, child_0, child_1, child_2, child_3, child_4])
                        return KeyboardEvent.key(seat)
                }()
        ...
        func cantoneseSymbolicKeys(_ needsInputModeSwitchKey: Bool) -> [[KeyboardEvent]] {
                ...
                let third_5: KeyboardEvent = {
                        let primary = KeyElement(text: "\u{2018}")
                        let child_0 = KeyElement(text: "\u{2018}", footer: "2018")
                        let child_1 = KeyElement(text: "\u{0027}", footer: "0027")
                        let child_2 = KeyElement(text: "\u{FF07}", header: "全形", footer: "FF07")
                        let child_3 = KeyElement(text: "\u{2018}", footer: "2018")
                        let child_4 = KeyElement(text: "\u{2019}", footer: "2019")
                        let child_5 = KeyElement(text: "\u{0060}", footer: "0060")
                        let seat: KeySeat = KeySeat(primary: primary, children: [child_0, child_1, child_2, child_3, child_4, child_5])
                        return KeyboardEvent.key(seat)
                }()
                var eventRows: [[KeyboardEvent]] = arrayTextArray.placeholders
