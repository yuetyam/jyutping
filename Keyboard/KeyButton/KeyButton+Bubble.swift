...
extension KeyButton {
        ...
        func rightBubblePath(origin: CGPoint, previewCornerRadius: CGFloat, keyWidth: CGFloat, keyHeight: CGFloat, keyCornerRadius: CGFloat, expansions: Int) -> UIBezierPath {
                ...
                let extendWith: CGFloat = (keyWidth + 4) * CGFloat(expansions) + previewCornerRadius
        ...
        func leftBubblePath(origin: CGPoint, previewCornerRadius: CGFloat, keyWidth: CGFloat, keyHeight: CGFloat, keyCornerRadius: CGFloat, expansions: Int) -> UIBezierPath {
