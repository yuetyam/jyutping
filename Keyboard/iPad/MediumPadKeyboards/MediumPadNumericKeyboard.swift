                ...
                VStack(spacing: 0) {
                        ...
                        HStack(spacing: 0) {
                                ...
                                Group {
                                        ...
                                        PadAdvancedInputKey(keyLocale: .trailing, upper: "}", keyModel: KeyModel(primary: KeyElement("\""), members: [KeyElement("\""), KeyElement("}"), KeyElement("\u{201D}", footer: "201D"), KeyElement("\u{201C}", footer: "201C")]))
                                }
