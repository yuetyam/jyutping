struct Constant {
        ...
        static let primaryCJKVQueue: [String] = ["Shanggu Sans", "Advocate Ancient Sans", "ChiuKong Gothic CL", "Chocolate Classical Sans", "Source Han Sans K", "Noto Sans CJK KR", "Sarasa Gothic CL"]
